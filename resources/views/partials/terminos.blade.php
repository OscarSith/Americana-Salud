...
Además, te comprometes a no llevar a cabo acciones que perjudiquen o puedan llegar a perjudicar los derechos, incluidos los derechos de propiedad intelectual, ostentados por NutriAmerican, sus compañías del grupo y/o sus otorgantes de licencias en el Software, las Marcas Registradas o el Contenido del sitio, y también te comprometes a no llevar a cabo acciones que perjudiquen la imagen o reputación de NutriAmerican, las compañías de su grupo, sus empleados, directivos ni consultores. </p></li>
   ...
   <li><p>TUS MANIFESTACIONES Y COMPROMISOS </p>
      ...
      <ol>
         ...
         <li><p>El cliente se compromete a proporcionar a NutriAmerican información correcta para enviar y procesar su orden. NutriAmericanno será responsable cuando el cliente proporcione equivocadamente su nombre, dirección o datos de facturación, por lo que los costos incurridos serán responsabilidad del cliente. </p></li>
      </ol>
   </li>     

   <li><p>INCUMPLIMIENTO </p>
      <ol>
         <li><p>Sin perjuicio de cualquier otro derecho, si un Usuario incumple total o parcialmente lo dispuesto en el presente Contrato, NutriAmerican se reserva el derecho a adoptar cualquier medida que estime oportuna, incluso la extinción del presente Contrato, así como el bloqueo inmediato del acceso al Servicio para dicho Usuario o la adopción de medidas legales en su contra.  </p></li>
         <li><p>Aceptas mantener indemnes, defender y eximir de toda responsabilidad a NutriAmerican, así como a sus directivos y empleados, de y contra reclamaciones, demandas, obligaciones, daños, pérdidas, costes y gastos, incluidos los honorarios legales y cualesquiera otras cargas, con independencia de su origen, que pudieran surgir como consecuencia de: </p>
            <ol>
               <li><p>El incumplimiento por tu parte del presente Contrato, ya sea total o parcialmente;  </p></li>
               <li><p>La violación por tu parte de cualquier norma legal o de los derechos de terceros; y  </p></li>
               <li><p>El uso del Servicio por tu parte, con o sin su autorización. </p></li>
   ...
   <li><p>GARANTÍAS </p>
      <ol>
         ...
         <li><p>A pesar de nuestros esfuerzos por suministrarte un servicio de la mayor calidad, fiabilidad y seguridad, no garantizamos que el Servicio sea ininterrumpido, puntual o que esté libre de errores, que puedan corregirse los defectos o que los servicios que se encuentren aquí estén libres de virus y fallos. </p></li>
         <li><p>NutriAmerican se reserva el derecho a suspender, interrumpir, modificar, aumentar o eliminar el Servicio con total discreción y con efectos inmediatos, sin la obligación de avisarte previamente en caso de que lo consideremos necesario, incluyendo (por ejemplo), casos en los que recibamos información acerca de que has firmado un acuerdo de autoexclusión con algún proveedor de juego, o casos en los que lo consideremos necesario para la gestión, mantenimiento o actualización del Software y sin asumir responsabilidad alguna por cualquier tipo de pérdida que se ocasionara como consecuencia de cualquier decisión tomada por nosotros a este respecto </p></li>
      </ol>
   </li>  
